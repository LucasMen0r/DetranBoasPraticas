...
async fn main() -> Result<(), Box<dyn Error>> {
   ...
   let exemplos = vec![
        ...
        ExemploInput {
            ...
            texto: "id",
            is_bom: false,
            explicacao: "Nome genérico, deve identificar a tabela.",
        },
        ...
        ExemploInput {
            ...
            texto: "fkVeiculo",
            is_bom: true,
            explicacao: "Utilização do nome do campo da Tabela Pai (nome de origem): Veiculo é a tabela-pai, pkVeiculo é a sua chave primária, a tabela filha, Servico, tem a sua própria pk[pkServico], e a fk será 'fkVeiculo'. Quando existir mais de uma “fk” para a mesma tabela pai, deve-se usar um número sequencial no final do nome da “fk”. Exemplo: fkVeiculoCategoriaVeiculo01",
        },
        ExemploInput {
            foco: "FK",
            texto: "FKveiculo",
